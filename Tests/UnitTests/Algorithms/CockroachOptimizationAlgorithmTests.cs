...
{
    [TestFixture]
    public class CockroachOptimizationAlgorithmTests
    {
        [Test, TestCaseSource("test_cases")]
        public void test_initializing_algorithm(int maxIterations, int populationCount, int maxStep, int visual, Core.JobScheduling.Base.SchedulingProblem schedulingProblem)
        {
            // Act
